...
Template.ownRecipePage.events({

    "click #popup_button": function(){
      $("#popup1").css("visibility", "visible");
      $("#popup1").css("opacity", 1);
      // console.log("loglog: "+Session.get("dict").analyzedInstructions[0].steps[0]);
      Session.set("ownStep", Myrecipe.findOne(this.toString()).analyzedInstructions[0].steps[0]);
    ...
    'click #ask': function(elt,instance){
            ...
            $.ajax({
              ...
              success: function(data) {
                ...
                if (data.result.action=='get_info'){
                    ...
                    var recipe = Myrecipe.findOne(instance.data);
